...
**In my regular work,applying the clean code pratices in my project,writing the testcases,updating the documentations,refactoring the legacy code,testing all the modules**
